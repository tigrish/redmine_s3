...
* Private file urls can expire a set time after the links were generated using the expires options 

== Options Detail
* access_key_id: string key
...
* verify_ssl: boolean true/false verify with aws cert bundle 
